          ...
          <div className="flex items-center text-base leading-5">
            ...
            {user.name ? (
              ...
              <div className="flex justify-center items-center space-x-4">
                ...
                <Link href="/auth/register" className="bg-primary-900 rounded-t-xl rounded-br-xl sm:px-2 sm:py-1 px-4 py-2 font-semibold sm:text-sm text-lg  text-white">Get Started</Link>   
              </div>
            )}
          </div>
          </div>
