                ...
                <>
                      <div className="-mr-2 flex">
                        <button
                            ...
                            className="inline-flex items-center justify-center p-2 rounded-md text-white hover:text-white hover:bg-primary-900 focus:outline-none focus:bg-primary-700 focus:text-white">
                    ...
                    <div className={`${isMobileMenuOpen ? 'block' : 'hidden'} border-b border-gray-700 md:hidden`}>
                        <div className="px-2 py-3 space-y-1 sm:px-3">
                            ...
                            <a onClick={logout} className="block px-3 py-2 rounded-md text-base font-medium text-indigo-300 hover:text-white hover:bg-indigo-700 focus:outline-none focus:text-white focus:bg-indigo-700">
                                Sign Out
                            </a>
                        </div>
                    </div>
