          ...
          <div className="flex items-center text-base leading-5">
            ...
            {user.name ? (
                <div className="flex justify-around space-x-4">
                    ...
                    <div className={`${isMobileMenuOpen ? 'block' : 'hidden'} absolute top-20 border-b border-gray-700 z-100`}>
                        <div className="px-2 py-3 space-y-1 sm:px-3">
                            <Link href="/dashboard">
                                <p className="block px-3 py-2 rounded-md text-base font-medium text-white bg-primary-900 focus:outline-none focus:text-white focus:bg-primary-700">
                                    Dashboard
                                </p>
                            </Link>
                            <Link href="account">
                                <p className="block px-3 py-2 rounded-md text-base font-medium text-primary-300 hover:text-white hover:bg-primary-700 focus:outline-none focus:text-white focus:bg-primary-700">
                                    Account Settings
                                </p>
                            </Link>
                            <button onClick={logout} className="block px-3 py-2 rounded-md text-base font-medium text-primary-300 hover:text-white hover:bg-primary-700 focus:outline-none focus:text-white focus:bg-primary-700">
                                Sign Out
                            </button>
                        </div>
                    </div>
