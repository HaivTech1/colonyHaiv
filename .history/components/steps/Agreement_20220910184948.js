...
const Agreement = () => {
  ...
  return (
    ...
    <p>
      ...
      <ul>
          <li>
            <p>Client should ensure he/she input valid and correct details when making payment, because receipt will be issued via 
            ...
            liable for any misinformation during payment.</p>
          </li>
          <li>
            <p>Client shall abide to the property rules stated in the property descriptions, this rules are directly from the property owners and might differ based on the property.</p>
          </li>
      </ul>
        2. 
