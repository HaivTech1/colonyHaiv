    ...
    <div className='mt-6'>
      <div className="flex justify-center items-center  flex-wrap">
            <Image
                ...
                width={400}
                height={400}
                className="mt-6 rounded-lg shadow-xl sm:mt-8 sm:h-64 sm:w-full sm:object-cover  object-center p-2 mx-2"
                placeholder="blur"
        ...
        <div className="flex-1 flext-grow">
            ...
            <h3 className="font-bold text-primary-900 text-md mt-2 sm:mt-4">
