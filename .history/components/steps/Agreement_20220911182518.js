    ...
    <div className='mt-6'>
      <div className="flex justify-center items-center  flex-wrap">
        ...
        <div className="flex-1 flext-grow">
            ...
            <h3 className="font-bold text-primary-900 text-md mt-2 sm:mt-4 leading-8 indent-3 whitespace-normal break-all text-lg">
              These terms and conditions outline the rules and regulations for the use of getting a 
              property from Colony.
            </h3>

            <blockquote className="mt-4 leading-8 indent-3 whitespace-normal break-all text-lg">
          ...
          <p className="mt-2 sm:mt-4 leading-8 indent-3 whitespace-normal break-all text-lg">
          ...
          <div className="mt-4 leading-8 indent-3 whitespace-normal break-all text-lg">
            ...
            <blockquote className="leading-8 indent-3 whitespace-normal break-all text-lg"> 
