...
import { currentAmenities  } from '../../utils/filterData'
...
const Amenities = () => {
  ...
  return (
    ...
    <p>
      With our professional workers, ours is to get professionals for your interior and
        ...
        <div className="block w-full overflow-x-auto">
              <form onSubmit={submitHandler}>
                <div className="grid grid-cols-1 md:grid-cols-3 sm:place-items-center">
                  {currentAmenities.map(({ name, value }) => (
                    <div key={name} className="mx-8 my-5 flex">
                      <input
                        ...
                        label={value}
                        value={value}
                        checked={currentAmenities.some((val) => val === value)}
