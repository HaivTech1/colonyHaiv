...
const Book = ({property}) => {
  ...
  return (
    <SectionContainer>
      ...
      <div class="w-full  md:max-w-none bg-white px-8 md:px-10 py-8 md:py-10 mb-3 mx-auto md:-mx-3 md:my-3 rounded-md shadow-lg shadow-gray-600 md:relative md:z-50 md:flex md:flex-col">
            <div class="w-full flex-grow">
                <h2 class="text-center font-bold uppercase mb-4">{title}</h2>
                <h3 class="text-center font-bold text-3xl md:text-4xl mb-2">#{price}<span class="text-lg"></span></h3>
                
                <h1 className="font-bold text-center text-lg sm:text-4xl text-primary-900">Payment Method</h1>
            ...
            <div class="w-full">
                <button onClick={handleBook} 
                  class="font-bold bg-primary-900 hover:bg-primary-700 text-white rounded-md px-10 py-2 transition-colors w-full">
                  Book Property
                </button>
            </div>
        </div>
