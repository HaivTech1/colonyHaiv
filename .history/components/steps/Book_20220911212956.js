...
const Book = ({property}) => {
  ...
  return (
    <SectionContainer>
      ...
      <div class="group relative w-full  md:max-w-none bg-white px-8 md:px-10 py-8 md:py-10 mb-3 mx-auto md:-mx-3 md:my-3 rounded-md shadow-lg shadow-gray-600 md:relative md:z-50 md:flex md:flex-col">
