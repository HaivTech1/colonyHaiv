      ...
      await client().post('auth/bookings', {
        ...
        paymentMethod,
          ...
          if(response.data.success === true ){
            ...
            if(response.data.booking.paymentMethod == 'transfer') setInterval(() => {
      ...
      <div className="w-full  md:max-w-none bg-white px-8 md:px-10 py-8 md:py-10 mb-3 mx-auto md:-mx-3 md:my-3 rounded-md md:relative md:z-50 md:flex md:flex-col">
            ...
            <div className="w-full flex justify-center">
                <button onClick={handleBook} 
                  className="bg-primary-900 rounded-t-xl rounded-br-xl px-4 py-2 font-semibold text-md text-white">
                  Book Property
                </button>
            </div>
        </div>
