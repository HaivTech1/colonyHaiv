...
const Payment = ({property}) => {
  ...
  return (
    <SectionContainer>
      <div className="mt-6">
        <div className="className="group flex bg-transparent bg-opacity-20 px-2 transition duration-100 hover:scale-105 hover:rounded-xl hover:bg-gray-100 dark:hover:bg-gray-800">
        <li className="py-6">
