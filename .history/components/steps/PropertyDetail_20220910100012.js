import { ClockIcon, LocationMarkerIcon, StarIcon } from '@heroicons/react/solid';
        ...
        <div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 mt-4 place-content-center'>
              ...
              <div className="p-4 rounded-xl sm:mt-2 mt-5 sm:ml-2 text-base ">
                <ReactPlayer url='https://www.youtube.com/watch?v=wWgIAphfn2U' className="border-2 border-primary-500 border-dashed aspect-video" />
              </div>
            </div>
