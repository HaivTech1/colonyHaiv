    ...
    <LayoutWrapper>
        ...
        <div className='flex flex-wrap justify-around mt-10 sm:mt-0'>
            ...
            <div className="flex-1 flex-grow">
                <div className="">
                    <ProfileInfo user={user} changeDetails={changeDetails} setErrors={setErrors} setStatus={setStatus}/>
                </div>

                <div className="mt-8">
                    <PasswordInfo changePassword={changePassword} setErrors={setErrors} setStatus={setStatus}/>
                </div>
                <div className="mt-8">
                    <TwoFactorInfo changePassword={changePassword} setErrors={setErrors} setStatus={setStatus}/>
                </div>
