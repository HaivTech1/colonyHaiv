  ...
  return (
    <LayoutWrapper>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2">
        <div className="pt-6">
          <h1 className="pb-6 text-3xl font-extrabold leading-9 tracking-tight text-gray-900 dark:text-gray-100 sm:text-3xl sm:leading-10 md:text-4xl md:leading-14">
          <Typewriter
              options={{
                strings: 'The future of living',
                autoStart: true,
                loop: true,
              }}
            />
            <span className="text-xl text-primary-color-500 dark:text-dark-500">
            {` ${siteMetadata.description}`}
            </span>
          </h1>

          <div className="hidden lg:block transition ease-in-out">
            <Image
              src="/static/home.jpg"
              alt="colony"
              width={300}
