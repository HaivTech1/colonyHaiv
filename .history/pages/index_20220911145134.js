    ...
    <LayoutWrapper>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2">
        <div className="pt-6">
          ...
          <h1 className="pb-6 text-lg font-extrabold leading-9 tracking-tight text-primary-900 dark:text-gray-100 sm:text-3xl sm:leading-10 md:text-4xl md:leading-14">
            <Typewriter
                options={{
