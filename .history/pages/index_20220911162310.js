...
export default function Home() {
  return (
    <LayoutWrapper>
      ...
      <div className="flex justify-around items-center my-12 bg-primary-500 py-8  rounded-[48px]">
           <div>
              <Image
                src="/static/rent.jpg"
                alt="colony"
           ...
           <div className="">
                <div className="bg-primary-700 p-4">Rent Properties</div>

                <h1 className="font-bold text-lg mt-4">Rent houses easily</h1>

                <p>
                  View all your rent in one place. Easily search and manage your rental income. 
                  Automate rent reminders to your tenants. Receive money into your account same day
                </p>
           </div>   
      </div>
    </LayoutWrapper>
