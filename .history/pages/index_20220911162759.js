...
export default function Home() {
  return (
    <LayoutWrapper>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 place-items-center my-12 bg-primary-500 py-8  rounded-[48px]">
              <Image
                src="/static/rent.jpg"
                alt="colony"
                width={600}
           ...
           <div className="relative">
                <div className="absolute topo-0 bg-primary-700 p-4">Rent Properties</div>

                <h1 className="font-bold text-lg my-6">Rent houses easily</h1>
