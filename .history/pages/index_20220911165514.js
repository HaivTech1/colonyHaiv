    ...
    <LayoutWrapper>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 place-items-center my-12 bg-primary-500 py-8 px-8  rounded-[48px]">
           ...
           <div className="">
                ...
                <h1 className="font-bold text-2xl my-12 text-white md:subpixel-antialiased">Rent Houses Easily</h1>

                <p className="text-white font-semi-bold leading-loose leading-8 indent-3 whitespace-normal break-all">
