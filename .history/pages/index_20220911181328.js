...
export default function Home() {
  return (
    <LayoutWrapper>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-24 place-items-center my-12 bg-primary-900 py-8 px-8  rounded-[48px]">
              <Image
           ...
           <div className="">
                ...
                <p className="text-white font-semi-bold leading-loose leading-8 indent-3 whitespace-normal break-all text-lg">
