...
const Payment = () => {
 ...
 // you can call this function anything
  ...
  return (
    <LayoutWrapper>
        <PageSEO title={message.title} description={message.message} />
        <div className="grid grid-cols-1 sm:grid-cols-2 place-items-center mt-5 sm:mt-10">
              
            <Modal isOpen={paymentSuccess} title='Payment Successful' message='You have successfully made payment for you booking!'>
