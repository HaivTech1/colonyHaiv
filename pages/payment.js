  ...
  const onSuccess = (reference) => {
    ...
    console.log(reference);
      if(reference.status === "success"){
        ...
        setMessage({'title': reference.message, 'message': 'Your payment was successfuly. Thank you!' });
  ...
  return (
    <LayoutWrapper>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 place-items-center mt-5 sm:mt-10">
            ...
            <div className="w-full  md:max-w-none bg-white dark:bg-background-color dark:text-white px-8 md:px-10 py-8 md:py-10 mb-3 mx-auto md:-mx-3 md:my-3 rounded-md md:relative md:z-50 md:flex md:flex-col">
